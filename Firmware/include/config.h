...
#define CLOUD_HOST "https://api.antaraga.web.id"
...
// =====================================================================
// Perangkat cek server setiap interval ini. Kalau ada firmware baru,
// langsung download dan flash tanpa kabel USB.
// Set ke 0 untuk nonaktifkan OTA check.
#define OTA_CHECK_INTERVAL_MS 60000 // cek tiap 60 detik
