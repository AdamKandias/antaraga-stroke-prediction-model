...
**Hasil:**
- Pendokumentasian proses kerja tim dalam bentuk foto dan rekaman untuk arsip serta bahan konten
- Penyusunan aset visual pendukung: templat kartu progres, bingkai unggahan, dan elemen grafis sesuai palet warna ANTARAGA (putih, hijau tosca, oranye)
- Penyiapan tata letak untuk menampilkan progres teknis agar dapat dipahami pembaca awam
...
**Hasil:**
- Penetapan tema konten kedua: memperkenalkan cara kerja ANTARAGA secara sederhana kepada khalayak umum
- Penyusunan alur cerita unggahan: masalah stroke pada lansia, keterbatasan pemeriksaan yang ada, lalu solusi yang ditawarkan ANTARAGA
- Perancangan tata letak carousel beserta pembagian isi tiap halaman
- Penetapan gaya visual yang konsisten dengan unggahan sebelumnya
...
**Hasil:**
- Pendokumentasian kondisi perangkat yang sudah terpasang lengkap, mencakup casing, PCB, sensor, dan baterai
- Perekaman tampilan dashboard pemantauan yang menampilkan sinyal PPG berjalan, sebagai bahan konten
- Penyusunan rancangan unggahan yang menampilkan perkembangan dari purwarupa awal sampai perangkat yang sudah berfungsi
...
**Hasil:**
- Perekaman tampilan dashboard pemantauan dengan sinyal PPG tiga kanal berjalan
- Pemotretan perangkat dalam kondisi terpasang lengkap
- Penyusunan rancangan unggahan yang menampilkan perkembangan dari purwarupa awal sampai perangkat berfungsi
- **Kendala**: perekaman layar perlu dipastikan tidak menampilkan alamat server internal maupun data subjek, sehingga bagian tersebut ditutup saat pengambilan gambar

📸 `ZEVEN_rekaman dashboard untuk konten.png`, `ZEVEN_rancangan unggahan progres.png`
...
**Hasil:**
- Perancangan tata letak lembar penjelasan penelitian agar tidak terkesan padat dan menakutkan
- Pembuatan gambar sederhana yang menjelaskan cara pemakaian smartband kepada subjek
- Penyiapan papan penanda sesi untuk keperluan dokumentasi foto
- Penyeragaman gaya visual dokumen dengan identitas ANTARAGA

📸 `ZEVEN_tata letak lembar penjelasan.png`, `ZEVEN_gambar cara pemakaian smartband.png`
...
**Hasil:**
- Pemotretan proses perekaman: pemasangan alat, pengukuran dengan alat medis, dan pencatatan hasil
- Perekaman video pendek untuk bahan konten dokumentasi kegiatan
- **Kendala**: pengambilan gambar harus menjaga kerahasiaan subjek, sehingga wajah tidak ditampilkan dan pengambilan diarahkan pada alat serta proses kerjanya
- Pengarsipan dokumentasi dengan penamaan berkas yang tertata per sesi

📸 `ZEVEN_dokumentasi pengujian kedua.png`, `ZEVEN_video proses perekaman.png`
...
**Hasil:**
- Pemotretan berkas lengkap sebelum diserahkan
- Dokumentasi foto saat penyerahan di sentra HKI kampus
- Penyusunan bahan visual untuk laporan kemajuan bagian luaran: status pengajuan HKI beserta buktinya
- Pengarsipan dokumentasi ke folder luaran

📸 `ZEVEN_dokumentasi berkas hki.png`, `ZEVEN_foto penyerahan berkas.png`
...
**Hasil:**
- Memahami cakupan perlindungan hak cipta atas karya visual: logo, desain antarmuka, dan materi promosi
- Pencatatan berkas yang perlu disiapkan bila karya visual ikut didaftarkan
- Pengarsipan berkas sumber desain sebagai bukti kepemilikan karya

📸 `ZEVEN_workshop hak cipta.png`, `ZEVEN_arsip berkas sumber desain.png`
...
**Hasil:**
- Pembuatan diagram alur sistem dari sensor sampai notifikasi ke keluarga
- Perapian tangkapan layar dashboard dan aplikasi agar seragam ukuran dan mudah dibaca saat dicetak
- Penyusunan tata letak dokumen laporan beserta penomoran gambar
- **Kendala**: sebagian tangkapan layar hasil kerja teknis terlalu padat untuk dicetak, sehingga perlu dipotong dan diberi sorotan pada bagian penting

📸 `ZEVEN_diagram alur sistem.png`, `ZEVEN_tata letak laporan kemajuan.png`
...
**Hasil:**
- Memahami kaidah penyusunan salindia yang mudah dibaca penilai: sedikit teks, banyak visual, satu gagasan per halaman
- Penyusunan kerangka salindia mengikuti alur presentasi yang disepakati tim
- Penyiapan templat salindia dengan identitas visual ANTARAGA

📸 `ZEVEN_workshop presentasi.png`, `ZEVEN_templat salindia presentasi.png`
...
**Hasil:**
- Penyelesaian salindia presentasi lengkap dengan diagram, tangkapan layar, dan grafik hasil
- Penerapan revisi visual pada laporan sesuai masukan dosen
- Penyesuaian salindia agar sesuai alokasi waktu presentasi

*(Catatan masukan dosen perlu dilengkapi sesuai asistensi yang sebenarnya.)*

📸 `ZEVEN_salindia presentasi selesai.png`, `ZEVEN_revisi visual laporan.png`
...
**Hasil:**
- Penyelesaian desain carousel yang menjelaskan cara kerja ANTARAGA
- Penyuntingan rekaman peragaan sistem menjadi video pendek
- Pemeriksaan akhir bersama tim agar tidak ada kredensial maupun identitas subjek yang tertayang
- Pengunggahan ke Instagram dan TikTok sesuai jadwal

📸 `ZEVEN_desain carousel konten ketiga.png`, `ZEVEN_video peragaan sistem.png`, `ZEVEN_konten terunggah.png`
...
**Hasil:**
- Pemotretan dan perekaman proses perekaman data
- Pengambilan gambar tampilan dashboard saat sesi berlangsung
- Pengarsipan dokumentasi per sesi dengan penamaan berkas tertata
